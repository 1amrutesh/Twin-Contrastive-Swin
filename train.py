...
from model import ModelFactory, Network
...
def get_args_parser():
    ...
    parser.add_argument(
        ...
        type=str,
        metavar="MODEL",
        choices=["swin-l", "resnet50", "resnet34", "resnet18"],
    ...
    parser.add_argument(
        "--data_path",
        default="/kaggle/input/electrical-insulator/electrical_insulator",
        type=str,
        help="dataset path",
    )
    parser.add_argument(
        ...
        type=str,
        help="dataset",
        choices=["MIAD", "CIFAR-10", "CIFAR-100", "ImageNet-10", "ImageNet"],
    )
    parser.add_argument(
        "--nb_cluster",
        default=2,
...
if __name__ == "__main__":
    ...
    wandb.init(project="clustering", config=args)
